...
export const NAV_PERMISSION: Record<string, AdminPermission> = {
  ...
  "/admin/royalty-rules": "royalties.read",
  "/admin/wallets": "royalties.read",
  "/admin/transactions": "royalties.read",
  "/admin/withdrawals": "royalties.read",
  "/admin/payout-settings": "settings.manage",
  "/admin/subscriptions": "subscriptions.manage",
  "/admin/plans": "settings.manage",
